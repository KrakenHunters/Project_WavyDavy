...
public class FlowManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        Event.OnGainFlow.AddListener(AddFlow);
    ...
    private void OnDisable()
    {
        ...
        Event.OnChangeGameState.RemoveAllListeners();
        Event.OnGainFlow.RemoveAllListeners();
        Event.OnFinishTransition.RemoveAllListeners();
    }
